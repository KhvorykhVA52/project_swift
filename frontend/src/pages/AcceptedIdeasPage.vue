...
const baseTechStack = {
  languages: [
    'Ada', 'Assembly', 'Blueprint', 'C', 'C#', 'C++', 'Clojure', 'COBOL', 'CSS',
    'Dart', 'Delphi', 'Elixir', 'Erlang', 'Fortran', 'GOLANG', 'Groovy', 'Haskell',
    'HTML', 'Java', 'JavaScript', 'Julia', 'Kotlin', 'Lisp', 'Lua', 'MATLAB',
    'Objective-C', 'Objective-J', 'Pascal', 'PHP', 'Prolog', 'Python', 'R', 'Ruby',
    'Rust', 'Scala', 'Scheme', 'Scratch', 'Swift', 'TypeScript', 'Visual Basic .NET'
  ],
  frameworks: [
    'AdonisJS', 'Angular', 'ASP.NET Core', 'Backbone.js', 'CakePHP', 'CodeIgniter',
    'Django', 'Dropwizard', 'Echo', 'Ember.js', 'Express.js', 'FastAPI', 'Flask',
    'Flutter', 'Gin', 'GraphQL Yoga', 'Koa.js', 'Laravel', 'Meteor', 'NestJS',
    'Next.js', 'Nuxt.js', 'Phoenix', 'React', 'Remix', 'Sinatra', 'Spring Boot',
    'Spring MVC', 'Svelte', 'SwiftUI', 'Symfony', 'UIKit', 'Vue', 'Yii'
  ],
  databases: [
    'Amazon Aurora', 'ArangoDB', 'Cassandra', 'ClickHouse', 'Cloud Firestore',
    'Couchbase', 'Cosmos DB', 'DynamoDB', 'Elasticsearch', 'Greenplum', 'HBase',
    'IBM Db2', 'InfluxDB', 'MariaDB', 'Memcached', 'Microsoft SQL Server', 'MongoDB',
    'MySQL', 'Neo4j', 'ObjectDB', 'Oracle', 'OrientDB', 'Percona Server', 'PostgreSQL',
    'RavenDB', 'Redis', 'RethinkDB', 'SQLite', 'TiDB'
  ],
  devops: [
    'Ansible', 'AWS CloudFormation', 'Azure DevOps', 'Azure Monitor', 'Chef',
    'CI/CD', 'CloudWatch', 'Consul', 'Datadog', 'Docker', 'Git',
    'Google Cloud Build', 'Google Cloud Monitoring', 'Grafana', 'JFrog Artifactory',
    'Jenkins', 'Kubernetes', 'Nagios', 'Nexus Repository', 'New Relic', 'PagerDuty',
    'Prometheus', 'Puppet', 'Sentry', 'SonarQube', 'Splunk', 'Sumo Logic', 'Terraform',
    'Vault'
  ]
};
